...
const OPTIONS: Option[] = [
  ...
  { key: 'dj', label: 'Luna Group DJ', icon: '🎧',
    ...
    href: '/memberships/dj' },
  { key: 'close_friend', label: 'Close Friends', icon: '⭐',
    blurb: 'Wednesday nights at Su Casa Rooftop. Bring your people, top of the week gets looked after.',
    href: '/memberships/close-friends' },
