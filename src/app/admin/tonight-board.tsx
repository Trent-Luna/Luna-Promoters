        ...
        return (
          <div key={v.venue_id}
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="sm:hidden text-xs text-luna-muted ml-auto whitespace-nowrap">{v.registered} reg · <span className="text-luna-gold">{v.checked_in}</span> in</span>
            </div>
            ...
            <div className="hidden sm:block text-right tabular-nums text-luna-muted">{rate}%</div>
